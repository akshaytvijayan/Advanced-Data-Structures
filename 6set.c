...
//T0 check the strings representation
int n;
...
//to find union at two set using bit string
...
//to find intersection at two set using bit string
...
//to find difference at two set using bit string 
